...
export type ToolKey = "cv-builder" | "find-jobs" | "interview-coach" | "cv-check" | "career-quiz";
export const ALL_TOOLS: ToolKey[] = ["cv-builder", "find-jobs", "interview-coach", "cv-check", "career-quiz"];
